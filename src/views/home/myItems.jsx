...
export default function MyItemsPage() {
    ...
    return (
        <div className="mx-auto max-w-lg px-4 pt-4 pb-24 lg:max-w-6xl lg:px-8">
            ...
            <div className="mt-4 flex rounded-xl bg-muted p-1">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 rounded-lg py-2.5 text-sm font-bold transition-colors ${activeTab === 'gave'
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 rounded-lg py-2.5 text-sm font-bold transition-colors ${activeTab === 'received'
                        ? 'bg-card card-shadow text-foreground'
                        : 'text-muted-foreground'
                        }`}
                >
